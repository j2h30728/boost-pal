    ...
    <form action={onValid} className="py-3 *:w-full ">
      <div className="flex flex-col gap-5 ">
        <label
          ...
          className=" border-2 border-primary w-full aspect-[5/3] mx-auto flex items-center justify-center flex-col text-primary rounded-[16px] border-dashed cursor-pointer bg-center bg-cover ">
          {!state.previewImage ? (
